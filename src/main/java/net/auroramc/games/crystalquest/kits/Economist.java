...
public class Economist extends Kit {
    ...
    public Economist() {
        super(4, 1, "&cEconomist", "Intrigued about the mining robots, economist spent hours finding out how to duplicate that technology to generate resources themselves.", Material.EMERALD, 15000);
    }
