...
public class TeamShop extends GUI {
    ...
    public TeamShop(AuroraMCGamePlayer player) {
        ...
        if (robotB.getEntity() != null) {
            this.setItem(4, 4, new GUIItem(Material.SKULL_ITEM, robotA.getEntity().getCustomName() + " (Level " + robotA.getLevel() + ")", 1, ";&rThis mines:;" + descs.get(robotA.getLevel())));
        } else {
        ...
        if (robotC.getEntity() != null) {
            this.setItem(4, 5, new GUIItem(Material.SKULL_ITEM, robotA.getEntity().getCustomName() + " (Level " + robotA.getLevel() + ")", 1, ";&rThis mines:;" + descs.get(robotA.getLevel())));
        } else {
