...
public class PlayerShop extends GUI {
    ...
    public PlayerShop(AuroraMCGamePlayer player) {
        ...
        switch (player.getPlayer().getInventory().getHelmet().getType()) {
            ...
            case IRON_HELMET: {
                item = new GUIItem(Material.DIAMOND_HELMET, "&3Helmet Upgrade", 1, ";&rClick here to upgrade to;&7Diamond Helmet;;&rCost: &b40 &6Gold.");
                break;
            }
            default: {
        ...
        switch (player.getPlayer().getInventory().getChestplate().getType()) {
            ...
            case IRON_CHESTPLATE: {
                item = new GUIItem(Material.DIAMOND_CHESTPLATE, "&3Chestplate Upgrade", 1, ";&rClick here to upgrade to;&7Diamond Chestplate;;&rCost: &b64 &6Gold.");
                break;
            }
            default: {
        ...
        switch (player.getPlayer().getInventory().getLeggings().getType()) {
            ...
            case IRON_LEGGINGS: {
                item = new GUIItem(Material.DIAMOND_LEGGINGS, "&3Leggings Upgrade", 1, ";&rClick here to upgrade to;&7Diamond Leggings;;&rCost: &b56 &6Gold.");
                break;
            }
            default: {
        ...
        switch (player.getPlayer().getInventory().getBoots().getType()) {
            ...
            case CHAINMAIL_BOOTS: {
                item = new GUIItem(Material.IRON_BOOTS, "&3Boots Upgrade", 1, ";&rClick here to upgrade to;&7Iron Boots;;&rCost: &b8 &6Gold.");
                break;
            }
            case IRON_BOOTS: {
                item = new GUIItem(Material.DIAMOND_BOOTS, "&3Boots Upgrade", 1, ";&rClick here to upgrade to;&7Diamond Boots;;&rCost: &b40 &6Gold.");
                break;
            }
            default: {
        ...
        switch (player.getPlayer().getInventory().getItem(pickSlot).getType()) {
            case STONE_PICKAXE: {
                item = new GUIItem(Material.IRON_PICKAXE, "&3Pickaxe Upgrade", 1, ";&rClick here to upgrade to;&7Iron Pickaxe;;&rCost: &b12 &7Iron.");
                break;
            }
            case IRON_PICKAXE: {
        ...
        switch (player.getPlayer().getInventory().getItem(axeSlot).getType()) {
            case WOOD_AXE: {
                item = new GUIItem(Material.STONE_AXE, "&3Axe Upgrade", 1, ";&rClick here to upgrade to;&7Stone Axe;;&rCost: &b8 &7Iron.");
                break;
            }
            case STONE_AXE: {
                item = new GUIItem(Material.IRON_AXE, "&3Axe Upgrade", 1, ";&rClick here to upgrade to;&7Iron Axe;;&rCost: &b12 &6Gold.");
                break;
            }
            case IRON_AXE: {
                item = new GUIItem(Material.DIAMOND_AXE, "&3Axe Upgrade", 1, ";&rClick here to upgrade to;&7Diamond Axe;;&rCost: &b32 &6Gold.");
                break;
            }
            default: {
